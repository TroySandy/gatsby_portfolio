...
import gold from '../../images/badges-webdev_gold.png';
import red from '../../images/badges-webdev_red.png';
import blue from '../../images/badges-blue.png';
              ...
              <div className="about-wrapper__info">
                ...
                <div className="about-wrapper__info-text">
                  ...
                  <svg
                    ...
                    data-prefix="fab"
                    data-icon="git"
                    class="svg-inline--fa fa-git fa-w-16"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    height="50px"
                  ...
                  <img src={xd} height="48px" />
                </div>
                <div className="about-wrapper__info-text">
                  <img src={gold} height="50px" /> <img src={blue} height="50px" />{' '}
                  <img src={red} height="50px" />
                </div>
                {resume && (
